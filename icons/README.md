...
- `3d-project-file.svg`: a folded file containing a primary object plus related
  scene objects, distinguishing a multi-object project from a single model.
...
changing it to `currentColor` when inlining the SVG.

## Research references

- Tabler Icons (MIT): https://github.com/tabler/tabler-icons
- Lucide (ISC): https://github.com/lucide-icons/lucide
- Material Icons (Apache 2.0): https://google.github.io/material-design-icons/
- Bootstrap Icons (MIT): https://icons.getbootstrap.com/

These files are newly drawn for this project and do not require a third-party
icon package at runtime.
